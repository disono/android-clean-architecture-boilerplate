package disono.webmons.com.clean_architecture.storage.networks.services.settings.api;
...
public interface SettingsAPI {
    ...
    Call<MeSchema> generalSettings(@Part("first_name") RequestBody first_name, @Part("last_name") RequestBody last_name,
    ...
    Call<MeSchema> securitySettings(@Field("email") String email,
