package disono.webmons.com.clean_architecture.domain.models;

import com.orm.SugarRecord;

import java.util.List;

import disono.webmons.com.clean_architecture.domain.repositories.MeRepository;
...
public class MeModel extends SugarRecord implements MeRepository {
    ...
    /**
     * Get profile details authenticated only
     *
     * @return
     */
    public static MeModel me() {
        return new MeModel().single();
    }
}
